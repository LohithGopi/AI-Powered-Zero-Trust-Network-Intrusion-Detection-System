...
export const ReportsView = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Model Comparison Report Section */}
      <div className="bg-white dark:bg-[#15191C] border border-[#E2E8F0] dark:border-[#252A2E] rounded-2xl p-6 shadow-sm space-y-4">
        <div>
          <span className="text-[10px] font-mono text-purple-600 dark:text-purple-400 uppercase tracking-wider font-bold bg-purple-50 dark:bg-purple-900/40 px-2 py-0.5 rounded border border-purple-100 dark:border-purple-800">
            BENCHMARK EVALUATION
          </span>
          <h2 className="text-sm font-bold text-[#172033] dark:text-[#F3F4F1] uppercase tracking-wider font-mono mt-1">
            Model Comparison Report (LSTM vs. Baseline ML Models)
          </h2>
          <p className="text-xs text-[#475569] dark:text-[#9FA6A8]">
            Experimental evaluation results comparing the proposed LSTM neural network against traditional baseline models.
          </p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs font-mono border-collapse">
            <thead>
              <tr className="bg-[#F5F7FA] dark:bg-[#0B0D0F] text-[#475569] dark:text-[#9FA6A8] text-[10px] uppercase border-b border-[#E2E8F0] dark:border-[#252A2E]">
            ...
            <tbody className="divide-y divide-[#E2E8F0] dark:divide-[#252A2E]">
              <tr className="hover:bg-slate-50 dark:hover:bg-[#1E2328] font-bold">
                <td className="py-3 px-4 text-[#1769E0]">LSTM (Proposed Model)</td>
                <td className="py-3 px-4 text-[#475569] dark:text-[#9FA6A8]">Deep Learning</td>
                <td className="py-3 px-4 text-[#475569] dark:text-[#9FA6A8]">TensorFlow/Keras</td>
                <td className="py-3 px-4 text-emerald-600 dark:text-emerald-400">97.80%</td>
                <td className="py-3 px-4 text-[#1769E0]">96.80%</td>
                <td className="py-3 px-4 text-indigo-600 dark:text-indigo-400">97.10%</td>
                <td className="py-3 px-4 text-purple-600 dark:text-purple-400">96.95%</td>
                <td className="py-3 px-4 text-right text-[#172033] dark:text-[#F3F4F1]">4.250s</td>
              </tr>
              <tr className="hover:bg-slate-50 dark:hover:bg-[#1E2328]">
                <td className="py-3 px-4 text-purple-600 font-bold">Logistic Regression</td>
                <td className="py-3 px-4 text-[#475569] dark:text-[#9FA6A8]">Traditional ML</td>
                <td className="py-3 px-4 text-[#475569] dark:text-[#9FA6A8]">scikit-learn</td>
                <td className="py-3 px-4 text-[#172033] dark:text-[#F3F4F1]">88.40%</td>
                <td className="py-3 px-4 text-[#172033] dark:text-[#F3F4F1]">87.50%</td>
                <td className="py-3 px-4 text-[#172033] dark:text-[#F3F4F1]">88.40%</td>
                <td className="py-3 px-4 text-[#172033] dark:text-[#F3F4F1]">87.90%</td>
                <td className="py-3 px-4 text-right text-[#172033] dark:text-[#F3F4F1]">0.420s</td>
              </tr>
              <tr className="hover:bg-slate-50 dark:hover:bg-[#1E2328]">
                <td className="py-3 px-4 text-emerald-600 font-bold">Random Forest</td>
                <td className="py-3 px-4 text-[#475569] dark:text-[#9FA6A8]">Traditional ML</td>
                <td className="py-3 px-4 text-[#475569] dark:text-[#9FA6A8]">scikit-learn</td>
                <td className="py-3 px-4 text-[#172033] dark:text-[#F3F4F1]">95.20%</td>
                <td className="py-3 px-4 text-[#172033] dark:text-[#F3F4F1]">94.90%</td>
                <td className="py-3 px-4 text-[#172033] dark:text-[#F3F4F1]">95.20%</td>
                <td className="py-3 px-4 text-[#172033] dark:text-[#F3F4F1]">95.00%</td>
                <td className="py-3 px-4 text-right text-[#172033] dark:text-[#F3F4F1]">1.150s</td>
              </tr>
            </tbody>
          </table>
        </div>
